        ...
        child: Container(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Center(child: Image.asset('assets/images/FlexG.png', height: 64, errorBuilder: (_, __, ___) => const Icon(Icons.savings, size: 48, color: AppColors.primaryBlue))),
                const SizedBox(height: 12),
                Text('Welcome back', style: Theme.of(context).textTheme.headlineSmall?.copyWith(color: AppColors.darkText, fontWeight: FontWeight.bold))
                    .animate()
                    .fadeIn()
                ...
                TextButton(
                  onPressed: () => Navigator.of(context).push(fadeSlideRoute(builder: (_) => const SignupScreen())),
